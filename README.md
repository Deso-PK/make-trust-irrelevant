...
And yes, I use AI tooling in this build. The architecture decisions and the invariants are mine, on the record with a filing date to prove when. If that's the part you want to argue about instead of the deny-mint-allow chain, that's your call.
